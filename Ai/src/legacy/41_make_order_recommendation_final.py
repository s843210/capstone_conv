...
INPUT_CSV = BASE_DIR / "outputs" / "reports" / "tomorrow_sales_prediction_final.csv"
OUTPUT_CSV = BASE_DIR / "outputs" / "reports" / "order_recommendation_final.csv"
SUMMARY_TXT = BASE_DIR / "outputs" / "reports" / "order_recommendation_final_summary.txt"
...
def main() -> None:
    ...
    # 1,2,3) recommended order calculation (int)
    ...
    lines: list[str] = []
    lines.append("Order Recommendation Final Summary")
